...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Pathfinder address"));
...
//	connect(poolAction, SIGNAL(triggered()), this, SLOT(gotoPoolBrowser()));
    ...
    aboutCardAction = new QAction(tr("Pathfinder Website"), this);
    aboutCardAction->setToolTip(tr("Go to Pathfinder website"));
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Pathfinder"), this);
    aboutAction->setToolTip(tr("Show information about Pathfinder"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Pathfinder"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Show / Hide"), this);
    encryptWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Encrypt Pathfinder..."), this);
    encryptWalletAction->setToolTip(tr("Encrypt or decrypt wallet"));
    encryptWalletAction->setCheckable(true);
    backupWalletAction = new QAction(QIcon(":/icons/filesave"), tr("&Backup Pathfinder..."), this);
    backupWalletAction->setToolTip(tr("Backup Pathfinder to another location"));
    changePassphraseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passphrase..."), this);
    changePassphraseAction->setToolTip(tr("Change the passphrase used for wallet encryption"));
    unlockWalletAction = new QAction(QIcon(":/icons/mint_open"), tr("&Unlock Pathfinder..."), this);
    unlockWalletAction->setToolTip(tr("Unlock Pathfinder"));
    lockWalletAction = new QAction(QIcon(":/icons/mint_closed"), tr("&Lock Pathfinder"), this);
    lockWalletAction->setToolTip(tr("Lock Pathfinder"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Pathfinder client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Pathfinder client"));
...
{
    QDesktopServices::openUrl(QUrl("http://pathfinders.me/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pathfinder network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Pathfinder address or malformed URI parameters."));
    }
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setToolTip(tr("Pathfinder is <b>encrypted</b> and currently <b>unlocked</b>"));
    ...
    case WalletModel::Locked:
        ...
        labelEncryptionIcon->setToolTip(tr("Pathfinder is <b>encrypted</b> and currently <b>locked</b>"));
        encryptWalletAction->setChecked(true);
        changePassphraseAction->setEnabled(true);
...
void BitcoinGUI::backupWallet()
{
    ...
    QString filename = QFileDialog::getSaveFileName(this, tr("Backup Pathfinder"), saveDir, tr("Pathfinder Data (*.dat)"));
    if(!filename.isEmpty()) {
        if(!walletModel->backupWallet(filename)) {
            QMessageBox::warning(this, tr("Backup Failed"), tr("There was an error trying to save Pathfinder data to the new location."));
        }
    }
}
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    else
    {
        ...
        if (pwalletMain && pwalletMain->IsLocked())
            labelStakingIcon->setToolTip(tr("Not staking because Pathfinder is locked"));
        else if (vNodes.empty())
            labelStakingIcon->setToolTip(tr("Not staking because Pathfinder is offline"));
        else if (IsInitialBlockDownload())
            labelStakingIcon->setToolTip(tr("Not staking because Pathfinder is syncing"));
        else if (!nWeight)
...
void BitcoinGUI::openFacebook() {
    QDesktopServices::openUrl(QUrl("https://twitter.com/pathfinderdevs"));
}
void BitcoinGUI::openTwitter() {
    QDesktopServices::openUrl(QUrl("https://twitter.com/pathfinderdevs"));
}
void BitcoinGUI::openReddit() {
    QDesktopServices::openUrl(QUrl("http://www.reddit.com/r/pathfinderdev"));
}
void BitcoinGUI::openBitcointalk() {
    QDesktopServices::openUrl(QUrl("https://bitcointalk.org/index.php?topic=778707/"));
}
void BitcoinGUI::openWebsite() {
    QDesktopServices::openUrl(QUrl("http://www.pathfinders.me/"));
}