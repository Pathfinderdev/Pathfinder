...
const string strMessageMagic = "Pathfinder Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexBest->nHeight < YEARLY_BLOCKCOUNT)
				nRewardCoinYear = 8 * MAX_MINT_PROOF_OF_STAKE; //first year 8%
			else if(pindexBest->nHeight < (2 * YEARLY_BLOCKCOUNT))
				nRewardCoinYear = 6 * MAX_MINT_PROOF_OF_STAKE; // year 2 6%
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Pathfinder", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "This is Pathfinder!!-";
        CTransaction txNew;
        txNew.nTime = 1411104543;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("6d007ca17974b41960b92c04f3be90e7e5d22458f65737be8bdb0375c28c186d"));
        block.print();
